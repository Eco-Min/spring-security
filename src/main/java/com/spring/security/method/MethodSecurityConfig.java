...
public class MethodSecurityConfig {
    ...
    public Advisor protectServicePointcut() {
        ...
        pointcut.setExpression("execution(* com.spring.security.DataService.getUser(..))");
    ...
    public Pointcut createCompositePointcut() {
        ...
        pointcut1.setExpression("execution(* com.spring.security.DataService.getUser(..))");

        AspectJExpressionPointcut pointcut2 = new AspectJExpressionPointcut();
        pointcut2.setExpression("execution(* com.spring.security.DataService.getOwner(..))");
